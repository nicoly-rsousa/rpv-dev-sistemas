...
import { regrasFormulario, type TypeForm } from './rules/form-rules';
...
export function App() {
  ...
  const { reset, ...formulario } = useForm<TypeForm>({
  ...
  // const teste = useSoma(10, 20)
  // console.log('VALOR SOMADO', teste.valorSomado)
  // console.log('NOME DO useSoma', teste.nome)
  // console.log('Função de Somar', teste.soma(200, 400))
